            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-12 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#03a4ed] focus:border-[#03a4ed] outline-none transition text-slate-900 bg-slate-50/50 placeholder:text-slate-400 text-sm"
                  placeholder="sua senha"
                />
                <button
                  type="button"
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 transition select-none"
